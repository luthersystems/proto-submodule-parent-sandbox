...
const (
	WeatherService_GetWeather_FullMethodName = "/weatherpb.v1.WeatherService/GetWeather"
)
...
var WeatherService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "weatherpb.v1.WeatherService",
	...
	Metadata: "weatherpb/v1/weather.proto",
}
